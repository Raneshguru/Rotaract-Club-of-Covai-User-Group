          ...
          <div className="bg-[#FAFAFA] min-h-screen flex flex-col relative">
            ...
            <section className="py-32 bg-[#111111] relative z-10 border-t border-[#D11221]/30 overflow-hidden">
               ...
               <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                   {[
                     { name: 'Rtr John Doe', role: 'PDRR 2023-24', nickname: 'Visionary', image: 'https://placehold.co/600x800/333333/555555?text=PDRR' },
                     { name: 'Rtr Jane Smith', role: 'PDRR 2022-23', nickname: 'Pioneer', image: 'https://placehold.co/600x800/333333/555555?text=PDRR' },
                     { name: 'Rtr Robert Brown', role: 'PDRR 2021-22', nickname: 'Titan', image: 'https://placehold.co/600x800/333333/555555?text=PDRR' }
                   ].map((member, idx) => (
                     <div 
                       key={idx} 
                       onClick={() => setSelectedMember(member)}
